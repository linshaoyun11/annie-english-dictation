...
export const CURRICULUM: UnitInfo[] = [
  ...
  // ==================== 三年级（PEP 三下 2024 秋新版） ====================
  {
    ...
    entries: [
      mk(3, 7, "word", "where", "/weə(r)/", "adv. 在哪里；到哪里"),
      mk(3, 7, "word", "from", "/frɒm/", "prep. （表示来源）来自；从……来"),
      mk(3, 7, "word", "about", "/əˈbaʊt/", "prep. 关于；大约"),
      mk(3, 7, "word", "today", "/təˈdeɪ/", "adv. 今天"),
      mk(3, 7, "word", "teacher", "/ˈtiːtʃə(r)/", "n. 教师"),
      mk(3, 7, "word", "student", "/ˈstjuːdnt/", "n. 学生"),
      mk(3, 7, "word", "after", "/ˈɑːftə(r)/", "prep., conj. 在……后面"),
      mk(3, 7, "word", "who", "/huː/", "pron. 谁；什么人"),
      mk(3, 7, "word", "girl", "/ɡɜːl/", "n. 女孩"),
      mk(3, 7, "word", "neighbour", "/ˈneɪbə(r)/", "n. 邻居"),
      mk(3, 7, "word", "boy", "/bɔɪ/", "n. 男孩"),
      mk(3, 7, "word", "woman", "/ˈwʊmən/", "n. 成年女子；妇女"),
      mk(3, 7, "word", "man", "/mæn/", "n. 成年男子；男人"),
      mk(3, 7, "word", "Mr", "/ˈmɪstə(r)/", "n. （用于男子的姓氏或姓名前）先生"),
      mk(3, 7, "word", "classmate", "/ˈklɑːsmeɪt/", "n. 同班同学"),
      mk(3, 7, "word", "he", "/hiː/", "pron. 他"),
      mk(3, 7, "word", "also", "/ˈɔːlsəʊ/", "adv. 也"),
      mk(3, 7, "word", "English", "/ˈɪŋɡlɪʃ/", "n. 英语 adj. 英语的"),
      mk(3, 7, "word", "she", "/ʃiː/", "pron. 她"),
      mk(3, 7, "word", "very", "/ˈveri/", "adv. 很；非常；十分"),
  ...
  },
  {
    ...
    entries: [
      mk(3, 8, "word", "has", "/hæz/", "v. （have 的第三人称单数形式）具有（某种外表、特性或特征）"),
      mk(3, 8, "word", "long", "/lɒŋ/", "adj. （长度或距离）长的"),
      mk(3, 8, "word", "body", "/ˈbɒdi/", "n. 身体"),
      mk(3, 8, "word", "short", "/ʃɔːt/", "adj. 短的；个子矮的"),
      mk(3, 8, "word", "leg", "/leɡ/", "n. 腿"),
      mk(3, 8, "word", "right", "/raɪt/", "adj. （意见或判断）准确，确切，恰当"),
      mk(3, 8, "word", "fat", "/fæt/", "adj. 肥的；肥胖的"),
      mk(3, 8, "word", "thin", "/θɪn/", "adj. 瘦的"),
      mk(3, 8, "word", "slow", "/sləʊ/", "adj. 缓慢的；慢的"),
      mk(3, 8, "word", "love", "/lʌv/", "v. 喜爱；爱"),
      mk(3, 8, "word", "tail", "/teɪl/", "n. 尾；尾巴"),
      mk(3, 8, "word", "her", "/hɜː(r)/", "adj. 她的"),
      mk(3, 8, "word", "gift", "/ɡɪft/", "n. 礼物"),
      mk(3, 8, "word", "picture", "/ˈpɪktʃə(r)/", "n. 图画；绘画"),
      mk(3, 8, "word", "card", "/kɑːd/", "n. 贺卡；慰问卡；卡片"),
      mk(3, 8, "word", "sing", "/sɪŋ/", "v. 唱（歌）；演唱"),
      mk(3, 8, "word", "dance", "/dɑːns/", "v. 跳舞"),
      mk(3, 8, "word", "talk", "/tɔːk/", "v. 说话；讲话；谈话"),
      mk(3, 8, "word", "face", "/feɪs/", "n. 脸；面孔"),
      mk(3, 8, "word", "all", "/ɔːl/", "adj. 所有 pron. 全部"),
      mk(3, 8, "word", "song", "/sɒŋ/", "n. 歌；歌曲"),
      mk(3, 8, "word", "or", "/ɔː(r)/", "conj. 或；或者；还是"),
      mk(3, 8, "word", "so", "/səʊ/", "adv. （表示大小或数量）这么，那么"),
      mk(3, 8, "word", "much", "/mʌtʃ/", "adj. 许多 det., pron. 大量"),
  ...
  },
  {
    ...
    entries: [
      mk(3, 9, "word", "eraser", "/ɪˈreɪzə(r)/", "n. 橡皮"),
      mk(3, 9, "word", "find", "/faɪnd/", "v. 找到；找回"),
      mk(3, 9, "word", "ruler", "/ˈruːlə(r)/", "n. 直尺"),
      mk(3, 9, "word", "pen", "/pen/", "n. 钢笔"),
      mk(3, 9, "word", "pencil", "/ˈpensl/", "n. 铅笔"),
      mk(3, 9, "word", "book", "/bʊk/", "n. 书；书籍"),
      mk(3, 9, "word", "bag", "/bæɡ/", "n. 包；袋"),
      mk(3, 9, "word", "paper", "/ˈpeɪpə(r)/", "n. 纸"),
      mk(3, 9, "word", "these", "/ðiːz/", "pron. 这些"),
      mk(3, 9, "word", "see", "/siː/", "v. 看见"),
      mk(3, 9, "word", "smell", "/smel/", "n. 闻（气味）"),
      mk(3, 9, "word", "taste", "/teɪst/", "v. 尝（味道）"),
      mk(3, 9, "word", "hear", "/hɪə(r)/", "v. 听见；听到"),
      mk(3, 9, "word", "touch", "/tʌtʃ/", "v. 触摸；碰"),
      mk(3, 9, "word", "nose", "/nəʊz/", "n. 鼻；鼻子"),
      mk(3, 9, "word", "tongue", "/tʌŋ/", "n. 舌；舌头"),
      mk(3, 9, "word", "class", "/klɑːs/", "n. 课；班级"),
      mk(3, 9, "phrase", "in class", "/ɪn klɑːs/", "在课堂上"),
      mk(3, 9, "word", "computer", "/kəmˈpjuːtə(r)/", "n. 计算机；电脑"),
      mk(3, 9, "word", "learn", "/lɜːn/", "v. 学；学习"),
  ...
  },
  {
    ...
    title: "Healthy food",
    entries: [
      mk(3, 10, "word", "breakfast", "/ˈbrekfəst/", "n. 早餐；早饭"),
      mk(3, 10, "word", "time", "/taɪm/", "n. 时间"),
      mk(3, 10, "word", "bread", "/bred/", "n. 面包"),
      mk(3, 10, "word", "egg", "/eɡ/", "n. （作食用的）蛋；鸡蛋"),
      mk(3, 10, "word", "milk", "/mɪlk/", "n. （牛或羊等的）奶"),
      mk(3, 10, "word", "noodle", "/ˈnuːdl/", "n. （常用复数）面条"),
      mk(3, 10, "word", "juice", "/dʒuːs/", "n. 果汁"),
      mk(3, 10, "word", "rice", "/raɪs/", "n. 大米"),
      mk(3, 10, "word", "meat", "/miːt/", "n. 肉"),
      mk(3, 10, "word", "vegetable", "/ˈvedʒtəbl/", "n. 蔬菜"),
      mk(3, 10, "word", "healthy", "/ˈhelθi/", "adj. 健康的"),
      mk(3, 10, "word", "plate", "/pleɪt/", "n. 盘子"),
      mk(3, 10, "word", "soup", "/suːp/", "n. 汤"),
      mk(3, 10, "word", "fruit", "/fruːt/", "n. 水果"),
      mk(3, 10, "word", "colourful", "/ˈkʌləfl/", "adj. 五彩缤纷的"),
      mk(3, 10, "word", "candy", "/ˈkændi/", "n. 糖果"),
      mk(3, 10, "word", "yummy", "/ˈjʌmi/", "adj. 很好吃的"),
  ...
  },
  {
    ...
    title: "Old things",
    entries: [
      mk(3, 11, "word", "boat", "/bəʊt/", "n. 小船；舟"),
      mk(3, 11, "word", "cool", "/kuːl/", "adj. （因时髦、漂亮且与众不同）酷的，绝妙的"),
      mk(3, 11, "word", "keep", "/kiːp/", "v. 保有；留着"),
      mk(3, 11, "word", "at", "/æt/", "prep. 在（某处）"),
      mk(3, 11, "word", "home", "/həʊm/", "n. 家；住所"),
      mk(3, 11, "word", "ball", "/bɔːl/", "n. 球"),
      mk(3, 11, "word", "doll", "/dɒl/", "n. 玩偶；玩具娃娃"),
      mk(3, 11, "word", "car", "/kɑː(r)/", "n. 小汽车；轿车"),
      mk(3, 11, "word", "on", "/ɒn/", "prep. （覆盖、附着）在……上"),
      mk(3, 11, "word", "shelf", "/ʃelf/", "n. （复数 shelves /ʃelvz/）架子"),
      mk(3, 11, "word", "in", "/ɪn/", "prep. 在……内；在……中"),
      mk(3, 11, "word", "box", "/bɒks/", "n. 盒子"),
      mk(3, 11, "word", "cap", "/kæp/", "n. 帽子"),
      mk(3, 11, "word", "map", "/mæp/", "n. 地图"),
      mk(3, 11, "word", "under", "/ˈʌndə(r)/", "prep. 在（或到、通过）……下面"),
      mk(3, 11, "word", "still", "/stɪl/", "adv. 还是；仍然"),
      mk(3, 11, "word", "put", "/pʊt/", "v. 放；安置"),
  ...
  },
  {
    ...
    entries: [
      mk(3, 12, "word", "fifteen", "/ˈfɪfˈtiːn/", "num. 十五"),
      mk(3, 12, "word", "twelve", "/twelv/", "num. 十二"),
      mk(3, 12, "word", "fourteen", "/fɔːˈtiːn/", "num. 十四"),
      ...
      mk(3, 12, "word", "pay", "/peɪ/", "v. 付费"),
      mk(3, 12, "word", "back", "/bæk/", "adv. 回到原处"),
