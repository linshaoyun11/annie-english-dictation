...
export const CURRICULUM: UnitInfo[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      mk(3, 2, "word", "green", "/ɡriːn/", "adj. 绿色的 n. 绿色"),
      mk(3, 2, "word", "yellow", "/ˈjeləʊ/", "adj. 黄色的"),
      mk(3, 2, "word", "blue", "/bluː/", "adj. 蓝色的；忧郁的 n. 蓝色"),
      mk(3, 2, "word", "black", "/blæk/", "adj. 黑色的 n. 黑色"),
      mk(3, 2, "word", "brown", "/braʊn/", "adj. 棕色的"),
      mk(3, 2, "word", "white", "/waɪt/", "adj. 白色的 n. 白色"),
      mk(3, 2, "word", "orange", "/ˈɒrɪndʒ/", "n. 橙子；橙色"),
  ...
  },
  {
    ...
    title: "Look at me! 看我！",
    entries: [
      mk(3, 3, "word", "face", "/feɪs/", "n. 脸 v. 面对"),
      mk(3, 3, "word", "ear", "/ɪə(r)/", "n. 耳朵"),
      mk(3, 3, "word", "eye", "/aɪ/", "n. 眼睛"),
      mk(3, 3, "word", "nose", "/nəʊz/", "n. 鼻子"),
      mk(3, 3, "word", "mouth", "/maʊθ/", "n. 嘴巴"),
      mk(3, 3, "word", "arm", "/ɑːm/", "n. 手臂 v. 武装"),
      mk(3, 3, "word", "hand", "/hænd/", "n. 手 v. 递"),
      mk(3, 3, "word", "head", "/hed/", "n. 头；领导 v. 前往"),
      mk(3, 3, "word", "leg", "/leɡ/", "n. 腿"),
      mk(3, 3, "word", "foot", "/fʊt/", "n. 脚；英尺"),
    ],
  },
  {
    grade: 3,
    ...
    entries: [
      ...
      mk(3, 4, "word", "bear", "/beə(r)/", "n. 玩具熊；熊"),
  ...
  },
  {
    ...
    entries: [
      ...
      mk(3, 5, "word", "water", "/ˈwɔːtə(r)/", "n. 水 v. 浇水"),
      mk(3, 5, "word", "juice", "/dʒuːs/", "n. 果汁"),
      mk(3, 5, "word", "cake", "/keɪk/", "n. 蛋糕"),
      mk(3, 5, "word", "egg", "/eɡ/", "n. 鸡蛋"),
      mk(3, 5, "word", "fish", "/fɪʃ/", "n. 鱼 v. 钓鱼"),
      mk(3, 5, "word", "milk", "/mɪlk/", "n. 牛奶 v. 挤奶"),
  ...
  },
  {
    ...
    entries: [
      mk(3, 6, "word", "one", "/wʌn/", "num. 一 pron. 一个"),
  ...
  },
  {
    ...
    entries: [
      mk(3, 9, "word", "thin", "/θɪn/", "adj. 瘦的；薄的"),
      mk(3, 9, "word", "fat", "/fæt/", "adj. 胖的；n. 脂肪"),
      mk(3, 9, "word", "tall", "/tɔːl/", "adj. 高的"),
      mk(3, 9, "word", "short", "/ʃɔːt/", "adj. 矮的；短的"),
      mk(3, 9, "word", "long", "/lɒŋ/", "adj. 长的 adv. 长期地"),
